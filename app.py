...
def send_otp_email(email, code, purpose='login'):
    ...
    subject = f"Your InvoiceSnap {purpose_text} code: {code}"
    html = f"""<div style="font-family:sans-serif;max-width:400px;margin:0 auto;padding:24px">
        <h2 style="color:#3b82f6">InvoiceSnap</h2>
...
def dashboard():
    ...
    # Currency symbols
    symbols = {'CAD': 'C$', 'INR': '₹', 'EUR': '€', 'USD': '$', 'GBP': '£', 'MYR': 'RM', 'SGD': 'S$'}
...
def generate_pdf(user, invoice, items):
    ...
    pdf_curr_map = {'CAD': 'C$', 'INR': 'Rs.', 'EUR': 'EUR ', 'USD': '$', 'GBP': 'GBP ', 'MYR': 'RM', 'SGD': 'S$'}
